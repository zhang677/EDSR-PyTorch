...
#python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset --ext sep_reset
#python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset --ext sep --epochs 300 --batch_size 32
python main.py --model EDSR --scale 2 --patch_size 96 --reset --ext sep --epochs 300 --batch_size 32 --n_GPUs 2
...
#python main.py --model EDSR --scale 3 --patch_size 144 --save edsr_baseline_x3 --reset --pre_train /home/nfs_data/zhanggh/EDSR-PyTorch/experiment/edsr_baseline_x2/model/model_latest.pt --ext sep_reset
#python main.py --model EDSR --scale 3 --patch_size 144 --save edsr_baseline_x3 --reset --pre_train /home/nfs_data/zhanggh/EDSR-PyTorch/experiment/edsr_baseline_x2/model/model_latest.pt --ext sep
